...
import { NResult, NSpace, NIcon, NH2, NText, NA, NP } from "naive-ui";
...
<template>
  <n-icon size="140" style="margin-top: 100px">
    <svg
  ...
  <n-h2>请在侧边栏设置赛码器</n-h2>
  <n-text>
    <n-p> 丰富、敏捷的赛码器。<br /> </n-p>

    <n-space justify="center">
      <n-a href="https://github.com/cxcn/gosmq" target="_blank">访问仓库</n-a>
      <n-a href="https://github.com/cxcn/gosmq/blob/main/LICENSE" target="_blank">本项目使用 GPLv2 协议</n-a>
    </n-space>
  </n-text>
</template>
